    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="accesses", to="nft.nftitem"),
                ),
            ],
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="nftitemaccess",
            index=models.Index(fields=["item", "accessed_at"], name="nft_item_access_idx"),
        ),
    ]
